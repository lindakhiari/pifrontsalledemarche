...
export class ProduitAssuranceService {
  private apiUrl = 'http://localhost8089/SalleDeMarche/api';
  ...
  deleteProduitAssurance(idProduit: number): Observable<void> {
    return this.http.delete<void>(`http://localhost8089/SalleDeMarche/api/produitassurance/delete/${idProduit}`);
  }
