...
@Component({
  selector: 'app-marcheUser',
  templateUrl: './marche-user.component.html',
  imports: [SharedModule, NgApexchartsModule,NavbarComponent,CommonModule],
  standalone: true,
  styleUrls: ['./marche-user.component.scss']
})
export class MarcheComponent implements OnInit {  @ViewChild('chart') chart!: ChartComponent;
