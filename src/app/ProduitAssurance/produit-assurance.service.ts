...
export class ProduitAssuranceService {
  private apiUrl = 'http://localhost:8089/ProjetSalleDeMarche/api';
  ...
  deleteProduitAssurance(idProduit: number): Observable<void> {
    return this.http.delete<void>(`http://localhost:8089/ProjetSalleDeMarche/api/produitassurance/delete/${idProduit}`);
  }
